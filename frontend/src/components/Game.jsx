...
export default function (props) {
  ...
  return (
    <div className="gameCanvas" id="game" onClick={onClick}>
      ...
      <div className="startup" style={{ display: welcome ? 'block' : 'none' }}>
        <div>Click to anywhere to start!</div>
        <div>Get 100 in a row for a prize :)</div>
      </div>
      <a className="link" href="https://codesandbox.io/s/white-resonance-0mgum" target="_blank">
        <Button type="primary">Adapted from CodeSandbox</Button>
      </a>
    </div>
  );
}
